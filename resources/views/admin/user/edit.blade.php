<x-admin-layout>
    <h1 class="p-4 text-2xl font-semibold">Edit User</h1>
    <x-splade-form :default="$user" :action="route('admin.users.update', $user)" method="PUT" class="p-4 space-y-2 bg-white rounded-md">
